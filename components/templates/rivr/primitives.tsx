  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className={cn(
          "absolute left-0 top-0 rounded-full border-0 transition-all duration-500 ease-out group-hover:w-full group-hover:bg-primary",
          restBackground,
      ...
      <span
        className={cn(
          "relative z-10 flex shrink-0 items-center justify-center text-foreground transition-colors duration-500 ease-out group-hover:text-primary-foreground",
          MENU_BUTTON_CHIP[size],
        )}
      >
      ...
      <span
        className={cn(
          "relative z-10 whitespace-nowrap text-foreground transition-colors duration-500 ease-out group-hover:text-primary-foreground",
