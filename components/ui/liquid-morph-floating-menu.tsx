...
function MenuButton({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "text-[24px] uppercase leading-none overflow-hidden transition-colors duration-300",
        hovered ? "text-[#DF6035]" : "text-white",
      )}
      style={{
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          animate={{
            backgroundColor: isOpen ? "#DF6035" : "#DF6035",
            borderColor: isOpen ? "#DF6035" : "#B84F2A",
          }}
        ...
        {/* Dark blue circle expanding from bottom */}
        <motion.div
          className="absolute left-1/2 bg-[#2A3656]"
          style={{
            width: "200%",
            height: "200%",
            borderRadius: "50%",
